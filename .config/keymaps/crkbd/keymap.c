...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      SFT_GUI,   KC_LT,   KC_GT, CURLY_L, CURLY_R, KC_EXLM,                         KC_0,    KC_1,    KC_2,    KC_3, KC_PERC,  UK_PND,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      SFT_GUI,   KC_LT,   KC_GT, CURLY_L, CURLY_R, KC_EXLM,                         KC_0,    KC_1,    KC_2,    KC_3, KC_PERC,   KC_NO,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                            KC_NO, KC_TRNS, KC_LSFT,    CTL_SPC, KC_BSPC,   KC_NO \
                                      //`--------------------------'  `--------------------------'
  ),
